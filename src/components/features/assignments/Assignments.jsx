...
const initialAssignments = [
    { id: 1, title: "Experiment 6 - Implementation of Binary Search Tree", dueDate: new Date("2025-09-26T23:59:00"), course: "AY 2025-26 MCA Sem I DSA - Batch 2", status: "Upcoming", initials: "AM", color: "#ef4444" },
    { id: 2, title: "Practical 10: Disk Scheduling", dueDate: new Date("2025-09-27T23:59:00"), course: "MCA B2 2025-26", status: "Upcoming", initials: "MB", color: "#8b5cf6" },
    { id: 3, title: "Exp-8 Generics", dueDate: new Date("2025-10-01T23:59:00"), course: "Java Programming - MCA Sem I 2025-26", status: "Upcoming", initials: "JP", color: "#f97316" },
    { id: 4, title: "Case Study 1", dueDate: new Date("2025-09-24T23:59:00"), course: "Business Analytics", status: "Past due", initials: "CS", color: "#6b7280" },
    { id: 5, title: "Mid-Term Report", dueDate: new Date("2025-09-20T23:59:00"), course: "Advanced Algorithms", status: "Completed", initials: "MT", color: "#10b981" },
];

// Sub-component for the "Create New" options view
        ...
        <div className="create-assignment-options">
            ...
            <div className="options-container">
                <div className="option-card">
                    <h4><span role="img" aria-label="robot">🤖</span> AI Generated</h4>
                    <p>Generate questions and structure with the help of AI.</p>
                    <Button className="primary">Create with AI</Button>
                </div>
                <div className="option-card">
                    <h4><span role="img" aria-label="pencil">✏️</span> Create Manually</h4>
                    <p>Build the assignment from scratch with full control.</p>
                    <Button className="outline">Create Manually</Button>
                </div>
            </div>
        </div>
        <Button onClick={() => setView('list')}>Back to Assignments</Button>
    </div>
);

// Sub-component for the main list view
const AssignmentListView = ({ setView }) => {
...
export default function Assignments() {
    const [view, setView] = useState('list'); // Can be 'list' or 'create'
    ...
    return (
        <Panel>
            ...
            {view === 'list' ? <AssignmentListView setView={setView} /> : <CreateAssignmentOptions setView={setView} />}
        </Panel>
    );
}
